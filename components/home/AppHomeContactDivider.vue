  ...
  <section class="contact-divider">
    <div class="row m-0">
      <div class="col-lg-6 text">
        <h3>Not sure what fits your business needs? Get free consultation!</h3>
        <p>
          Experience you can trust, service you can count on. Seven Company –
          ...
          <div class="row m-0">
            <div class="col" style="padding-left: 0">
              <div class="form-group">
                <label for=""
                  >Name <span style="color: var(--main-color)">*</span></label
                >
